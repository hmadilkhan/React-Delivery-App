import { WEBSITE_URL,DELVIERY_URL } from "./website";
...
export const NOTIFICATION_TOKEN_URL = DELVIERY_URL + "/save-notification-token";
...
/* Delivery URLs */
export const LOGIN_DELIVERY_USER_URL = DELVIERY_URL + "/delivery/login";
export const UPDATE_DELIVERY_USER_INFO_URL = DELVIERY_URL + "/delivery/update-user-info";
export const GET_DELIVERY_ORDERS_URL = DELVIERY_URL + "/delivery/get-delivery-orders";
export const GET_SINGLE_DELIVERY_ORDER_URL = DELVIERY_URL + "/delivery/get-single-delivery-order";
export const SEND_DELIVERY_GUY_GPS_LOCATION_URL = DELVIERY_URL + "/delivery/set-delivery-guy-gps-location";
export const GET_DELIVERY_GUY_GPS_LOCATION_URL = WEBSITE_URL + "/public/api/delivery/get-delivery-guy-gps-location";
export const ACCEPT_TO_DELIVER_URL = DELVIERY_URL + "/delivery/accept-to-deliver";
export const PICKEDUP_ORDER_URL = DELVIERY_URL + "/delivery/pickedup-order";
export const DELIVER_ORDER_URL = DELVIERY_URL + "/delivery/deliver-order";
export const TOGGLE_DELIVERY_GUY_STATUS_URL = WEBSITE_URL + "/public/api/delivery/toggle-delivery-guy-status";
export const DELIVERY_COMPLETED_ORDERS_URL = DELVIERY_URL + "/delivery/get-completed-orders";
